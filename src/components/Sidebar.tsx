...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar, closeSidebar }) => {
  ...
  return (
    <>
      <aside
        className={`fixed top-0 left-0 h-full w-[250px] lg:h-auto dark:bg-tokena-dark-blue-1 border-r dark:border-tokena-dark-gray dark:border-opacity-40 transform lg:static bg-white ${
